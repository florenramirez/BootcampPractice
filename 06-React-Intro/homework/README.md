...
Crear un componente denominado "Busqueda" que va a utilizarse para luego poder encontrar las ciudades sobre las cuales se desee ver el clima actual. Para ello deberán crearse dentro de la carpeta de "componentes" los siguientes dos archivos:
...
Este Componente recibe por props una función `onSearch` que deberá ejecutar cuando se haga click en el botón `Agregar`.

> Nota: Van a tener que usar un `formulario` para lograr esto. [Acá](https://es.reactjs.org/docs/forms.html#controlled-components) van a ver la documentación de React de cómo hacer un formulario simple.

### Instrucciones para correr el proyecto

Desde la carpeta raíz `hw1-weathercard` se pueden ejecutar los siguientes comandos:
