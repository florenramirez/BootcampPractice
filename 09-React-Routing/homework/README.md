...
### Cofiguración inciail

1. Ejecutar el comnado `npm install`
2. Vamos a tener que instalar `react-router-dom`. Para eso hacemos:

```shell
npm install --save react-router-dom
```

3. Ejecutar el comando `npm start` para comenzar a correr la aplicación
