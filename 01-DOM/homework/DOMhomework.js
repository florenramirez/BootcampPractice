...
var span = document.querySelector('#createdBy').innerHTML += ' Florencia.'
...
function displayToDos() {
  ...
  var addtodo = buildToDos(toDoItems);
  for (var i=0; i < addtodo.length ;i++){
    toDoContainer.appendChild(addtodo[i]);
  } 
...
function completeToDo(event) {
  ...
  // Tu código acá:
  toDoItems[index].completeToDo(); // completo la lista
  displayToDos();
